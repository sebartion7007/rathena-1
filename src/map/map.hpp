...
enum _sp {
	...
	SP_CAPDAMAGE_RATE = 3001, SP_CAPDAMAGE_VAL, SP_CAPDAMAGE_NM_CHANCE, SP_CAPDAMAGE_SK_CHANCE, SP_SUPPLEMENTARY, SP_SKILLRATE, SP_SKILLRATE_DEF, SP_SKILLSUPPLEMENT,
	SP_DAMAGE_AMPLIFY,SP_MAGIC_HP_DRAIN_RATE,SP_MAGIC_SP_DRAIN_RATE
};
