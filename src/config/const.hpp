...
#ifdef RENEWAL
	#define MOB_FLEE(mob) ( ( mob->lv * 5 ) + ( mob->status.agi * ( mob->lv > 150 ? 2 : 1) )  + 100 )
	#define MOB_HIT(mob)  ( ( mob->lv * ( mob->lv > 100 ? 5 + (1 + (mob->lv - 100 )/100 ) : 5 )  ) + ( mob->status.dex * ( mob->lv > 150 ? 2 : 1) ) + 175 )
#else
